        ...
        for (Bloco blocoCall : blocosRepetidos)            
            ...
            for (int blocoBuff : memoria) {
                ...
                if (idCall == blocoBuff) {
                    ...
                    //Implementar LRU
                    pos = 0;
                    lru = ordenaVetorLRU(lru, pos, Bloco.byteToInt(Bloco.getBytes(blocoArq.dados, 1, 3)));

                    //Atualiza Memoria
                    memoria = ordenaVetorLRU(memoria, pos, Bloco.byteToInt(Bloco.getBytes(blocoArq.dados, 1, 3)));
